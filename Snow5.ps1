...
public static void MouseDown()
{
    ...
    //Scroll down
    input[5].mi.dwFlags = MOUSEEVENTF_XDOWN;
   
    
    SendInput(5, input, Marshal.SizeOf(input[0]));
}
}
...
## Type gareth rouse in "assiged to"
Add-Type -AssemblyName System.Windows.Forms    
sleep -seconds 0.1
'Gareth Rous'.ToCharArray() | ForEach-Object {[System.Windows.Forms.SendKeys]::SendWait($_)}
sleep -seconds .7
